        ...
        <div className="parent">
          <div className="resgister">
            <form onSubmit={submit}>
                ...
                <label htmlFor="repeat">Repeat passwordword</label>
                <input id="repeat" 
                type="password" 
                placeholder="Enter The Seem passwordword" 
                value={repeat}
                onChange={(e) => {
                    setRepeat(e.target.value)
                }}/>
                {repeat !== password && accept &&  <p className="error">passwordword does not match</p>}
