...
class User(AbstractBaseUser, PermissionsMixin):
 ...
 # This adheres to the principle of separation of concerns,
    ...
    def tokens(self):
        refresh = RefreshToken.for_user(self)   # Its primary purpose is to obtain a new access token without requiring the user to re-enter their credentials (like username and password) after the access token expires.
        return {
            'refresh' : str(refresh),
